...
export async function startAttempt(testId) {
  const response = await fetch(`${API_BASE}/tests/${testId}/attempt`, {
    ...fetchOptions,
    method: "POST",
  });
...
export async function getAttemptQuestions(attemptId) {
  const response = await fetch(`${API_BASE}/attempt/${attemptId}/question`, {
    ...fetchOptions,
    method: "GET",
  });
...
export async function postAnswer(attemptId, questionPosition, text) {
  const response = await fetch(
    `${API_BASE}/attempt/${attemptId}/question/${questionPosition}/submit`,
    {
      ...fetchOptions,
      method: "POST",
...
export async function submitAttempt(attemptId) {
  const response = await fetch(`${API_BASE}/attempt/${attemptId}/submit`, {
    ...fetchOptions,
    method: "POST",
  });
...
export async function createAIDialogue(attemptId, questionPosition) {
  const response = await fetch(
    `${API_BASE}/attempt/${attemptId}/question/${questionPosition}/ai/start`,
    {
      ...fetchOptions,
      method: "POST",
    }
...
export async function sendAIMessage(
  ...
  const response = await fetch(
    `${API_BASE}/attempt/${attemptId}/question/${questionPosition}/ai/${threadId}/send`,
    {
      ...fetchOptions,
      method: "POST",
...
export async function getAttemptResults(attemptId) {
  const response = await fetch(`${API_BASE}/attempt/${attemptId}/result`, {
    ...fetchOptions,
    method: "GET",
  });
